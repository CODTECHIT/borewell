          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <div className="space-y-5">
                {[
                  { icon: <Phone size={20} />, label: "Phone", value: "90424 32061", href: "tel:9042432061" },
                  { icon: <MessageCircle size={20} />, label: "WhatsApp", value: "90424 32061", href: "https://wa.me/919042432061" },
                  { icon: <Mail size={20} />, label: "Email", value: "n.ranjithkumar18@gmail.com", href: "mailto:n.ranjithkumar18@gmail.com" },
                  { icon: <MapPin size={20} />, label: "Address", value: "Electronic City, Bangalore - 560100" },
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Or call directly: <a href="tel:9042432061" className="text-primary">90424 32061</a>
                </p>
              </form>
            </motion.div>
          </div>
